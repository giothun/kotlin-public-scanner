...
class PublicDeclarationVisitorTest {
    ...
    inner class ComplexDeclarationsTest {
        ...
        fun `generic classes and functions are processed correctly`() {
            ...
            assertTrue(
                messages.contains("fun <X>transform"),
                "Should contain method with generic method type parameter"
            )
        }
    ...
    inner class EdgeCasesTest {
        ...
        fun `coroutines and suspend functions are processed correctly`() {
            ...
            assertTrue(
                messages.contains("suspend fun processWithContext"),
                "Should contain suspend function with context"
            )
            assertTrue(
                messages.contains("interface AsyncRepository"),
                "Should contain interface with suspend functions"
            )
            assertTrue(messages.contains("suspend fun getData"), "Should contain suspend interface method")
            assertTrue(
                messages.contains("suspend fun saveData"),
                "Should contain suspend interface method with parameters"
            )
        }
